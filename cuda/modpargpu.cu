...
int main(int argc, char **argv)
{
    ...
    int rows, cols;    /*Change: Take rows and columns as argv[2] & argv[3]*/
    ...
    int numBlocks = (num/(rows*cols));
    dim3 blockDims(rows, cols);
    
    /*if(num % 1024)*/
           /*++blocks;*/

    calculate<<<numBlocks, blockDims>>>(gpu_mem, num);
